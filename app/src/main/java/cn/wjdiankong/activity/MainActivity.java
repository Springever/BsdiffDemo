...
public class MainActivity extends Activity {
	...
	private class DiffTask extends AsyncTask<String, Void, Integer> {
		...
		protected Integer doInBackground(String... params) {
			...
			try {
				appDir = "/sdcard/HRBVB_YDYX_Android_1.0.apk";
				newDir = "/sdcard/HRBVB_YDYX_Android_1.2.apk";
				patchDir = "/sdcard/hrbvbydyx.patch";
	...
	private class PatchTask extends AsyncTask<String, Void, Integer> {
		...
		protected Integer doInBackground(String... params) {
			...
			try {
				// 指定包名的程序源文件路径
				appDir = "/sdcard/HRBVB_YDYX_Android_1.0.apk";
				newDir = "/sdcard/HRBVB_YDYX_Android_2.0_new.apk";
				patchDir = "/sdcard/hrbvbydyx.patch";
				Log.i("jw", "newapp:"+newDir+",oldapp:"+appDir);
				...
				if (result == 0) {
					runOnUiThread(new Runnable() {
						...
						public void run() {
					        ...
					        intent.setDataAndType(Uri.parse("file:///sdcard/HRBVB_YDYX_Android_1.2_new.apk"),
